...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex justify-between items-center h-24 max-w-[80%] mx-auto px-4 text-white bg-[#051026]'>
        <h1 className='w-auto pl-[30px] pr-[30px] text-3xl font-bold text-[#D3E1FF] bg-[#051026] square border-2 border-e-0 border-t-0 p-3' style={{borderRadius: '22.5px', borderColor: '#081B40'}}>Home Page</h1>
        <ul className='md:flex bg-[#051026] w-auto h-[60px] text-[#D3E1FF] border-2 border-s-0 border-t-0' style={{borderRadius: '22.5px', borderColor: '#081B40'}}>
