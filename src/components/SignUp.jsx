    ...
    <div  class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class="w-full bg-white rounded-lg shadow dark md:mt-0 sm:max-w-md xl:p-0 ">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-xl font-bold leading-tight tracking-tight text-[#32CD32] md:text-2xl " >Sign up</h1>
                <form>
                    <div>
                    ...
                    <br />
                    <div>
                        <button type="submit" onClick={handleClick} class="w-full text-white bg-[#0E327A] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign in</button>
                        {err && <p class="text-center text-[#ff0000]">{err}</p>}
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Have an account? <a href="/login" class="font-medium text-[#0E327A] hover:underline ">Log In</a>
                        </p>
                    </div>
